...
export const RecoveryEmail = ({ confirmationUrl }: Props) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Restablecer tu contraseña de VISTACEO</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Pediste cambiar la contraseña de tu cuenta en <strong>VISTACEO</strong>. Presioná el botón para crear una nueva:
        </Text>
        <Section style={{ textAlign: 'center', margin: '28px 0' }}>
          <Button style={button} href={confirmationUrl}>Crear nueva contraseña</Button>
        </Section>
        <Text style={footer}>Si no pediste este cambio, podés ignorar este mensaje. Tu contraseña actual seguirá siendo válida.</Text>
        <div style={divider} />
