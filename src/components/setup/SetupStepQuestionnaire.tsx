// Step: Questionnaire v12 - 100% AI-Generated Dynamic Questions
// All questions are generated by AI - no static fallbacks
// Covers all 7 health dimensions with balanced distribution
import { motion, AnimatePresence } from 'framer-motion';
import { useEffect, useMemo, useState, useCallback, useRef } from 'react';
import { ChevronRight, ChevronLeft, Check, HelpCircle, Sparkles, Brain, RefreshCw, AlertTriangle } from 'lucide-react';
...
export const SetupStepQuestionnaire = ({
  ...
  const generateQuestions = useCallback(async () => {
    ...
    try {
      ...
      console.warn('AI questionnaire generation failed (attempt ' + (retryCount + 1) + '):', err);
  ...
  }, [businessTypeLabel, businessTypeId, areaId, countryCode, setupMode, rawUserText, universalProfile, retryCount]);
  ...
  }, [isGenerating, currentQuestion, activeQuestions.length]);
  ...
  if (generationError && activeQuestions.length === 0) {
    return (
      <div className="space-y-8 max-w-lg mx-auto flex flex-col items-center justify-center min-h-[400px]">
