...
import { 
  ...
  ChevronDown, ChevronUp, DollarSign, Hash, HelpCircle
} from "lucide-react";
        ...
        {showHeader && (
          <div className="px-5 pt-5 pb-0">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="right" className="max-w-[220px] text-xs">
                    <p>Registrá rápido cómo va tu negocio. El sistema usa esta info para darte mejores recomendaciones cada día.</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <p className="text-[11px] text-muted-foreground mb-4">
              {format(appliesTo, "EEEE d 'de' MMMM", { locale: es })} · Un toque y listo
            </p>
          </div>
        )}
