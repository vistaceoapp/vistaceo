...
const COUNTRY_CONFIG: Record<string, CountryInfo> = {
  ...
  AR: {
    ...
    prices: { monthly: 49990, yearly: 287880 },
    flag: "🇦🇷",
    locale: "es-AR",
    name: "Argentina",
  },
  ...
  CL: {
    ...
    prices: { monthly: 42990, yearly: 239880 },
    flag: "🇨🇱",
    locale: "es-CL",
    name: "Chile",
  },
  ...
  CO: {
    ...
    symbol: "$",
    paymentProvider: "paypal",
    prices: { monthly: 199900, yearly: 1198800 },
    flag: "🇨🇴",
    locale: "es-CO",
    name: "Colombia",
  },
  ...
  CR: {
    ...
    symbol: "₡",
    paymentProvider: "paypal",
    prices: { monthly: 24990, yearly: 149880 },
    flag: "🇨🇷",
    locale: "es-CR",
    name: "Costa Rica",
  },
  ...
  MX: {
    ...
    symbol: "$",
    paymentProvider: "paypal",
    prices: { monthly: 849, yearly: 4740 },
    flag: "🇲🇽",
    locale: "es-MX",
    name: "México",
  },
  ...
  PY: {
    ...
    symbol: "₲",
    paymentProvider: "paypal",
    prices: { monthly: 369900, yearly: 2159880 },
    flag: "🇵🇾",
    locale: "es-PY",
    name: "Paraguay",
  },
  ...
  UY: {
    ...
    symbol: "$",
    paymentProvider: "paypal",
    prices: { monthly: 1990, yearly: 11880 },
    flag: "🇺🇾",
    locale: "es-UY",
    name: "Uruguay",
  },
  ...
  BO: {
    ...
    symbol: "Bs",
    paymentProvider: "paypal",
    prices: { monthly: 339, yearly: 1908 },
    flag: "🇧🇴",
    locale: "es-BO",
    name: "Bolivia",
  },
  ...
  DO: {
    ...
    symbol: "RD$",
    paymentProvider: "paypal",
    prices: { monthly: 2890, yearly: 16680 },
    flag: "🇩🇴",
    locale: "es-DO",
  ...
  GT: {
    ...
    symbol: "Q",
    paymentProvider: "paypal",
    prices: { monthly: 389, yearly: 2268 },
    flag: "🇬🇹",
    locale: "es-GT",
    name: "Guatemala",
  },
  ...
  HN: {
    ...
    symbol: "L",
    paymentProvider: "paypal",
    prices: { monthly: 1190, yearly: 6948 },
    flag: "🇭🇳",
    locale: "es-HN",
    name: "Honduras",
  },
  ...
  NI: {
    ...
    symbol: "C$",
    paymentProvider: "paypal",
    prices: { monthly: 1790, yearly: 10680 },
    flag: "🇳🇮",
    locale: "es-NI",
    name: "Nicaragua",
  },
  ...
  PE: {
    ...
    symbol: "S/",
    paymentProvider: "paypal",
    prices: { monthly: 185, yearly: 1068 },
    flag: "🇵🇪",
    locale: "es-PE",
    name: "Perú",
  },
