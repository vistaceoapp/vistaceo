...
const COUNTRY_CONFIG: Record<string, CountryInfo> = {
  ...
  CL: {
    ...
    prices: { monthly: 42990, yearly: 240000 },
    flag: "🇨🇱",
    locale: "es-CL",
    name: "Chile",
  },
  ...
  CO: {
    ...
    symbol: "$",
    paymentProvider: "paypal",
    prices: { monthly: 199900, yearly: 1200000 },
    flag: "🇨🇴",
    locale: "es-CO",
    name: "Colombia",
  },
  ...
  CR: {
    ...
    symbol: "₡",
    paymentProvider: "paypal",
    prices: { monthly: 24990, yearly: 150000 },
    flag: "🇨🇷",
    locale: "es-CR",
    name: "Costa Rica",
  },
  ...
  MX: {
    ...
    symbol: "$",
    paymentProvider: "paypal",
    prices: { monthly: 849, yearly: 4800 },
    flag: "🇲🇽",
    locale: "es-MX",
    name: "México",
  },
  ...
  PY: {
    ...
    symbol: "₲",
    paymentProvider: "paypal",
    prices: { monthly: 369900, yearly: 2160000 },
    flag: "🇵🇾",
    locale: "es-PY",
    name: "Paraguay",
  },
  ...
  BO: {
    ...
    symbol: "Bs",
    paymentProvider: "paypal",
    prices: { monthly: 339, yearly: 1980 },
    flag: "🇧🇴",
    locale: "es-BO",
    name: "Bolivia",
  },
  ...
  DO: {
    ...
    symbol: "RD$",
    paymentProvider: "paypal",
    prices: { monthly: 2890, yearly: 16800 },
    flag: "🇩🇴",
    locale: "es-DO",
  ...
  GT: {
    ...
    symbol: "Q",
    paymentProvider: "paypal",
    prices: { monthly: 389, yearly: 2280 },
    flag: "🇬🇹",
    locale: "es-GT",
    name: "Guatemala",
  },
  ...
  HN: {
    ...
    symbol: "L",
    paymentProvider: "paypal",
    prices: { monthly: 1190, yearly: 7200 },
    flag: "🇭🇳",
    locale: "es-HN",
    name: "Honduras",
  },
  ...
  NI: {
    ...
    symbol: "C$",
    paymentProvider: "paypal",
    prices: { monthly: 1790, yearly: 10800 },
    flag: "🇳🇮",
    locale: "es-NI",
    name: "Nicaragua",
  },
  ...
  PE: {
    ...
    symbol: "S/",
    paymentProvider: "paypal",
    prices: { monthly: 185, yearly: 1080 },
    flag: "🇵🇪",
    locale: "es-PE",
    name: "Perú",
  },
