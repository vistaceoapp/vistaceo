...
const FAQSection = () => {
  ...
  const faqs = [
    { q: "¿Qué es VISTACEO?", a: "VISTACEO es una plataforma con inteligencia artificial que funciona como un CEO digital para tu empresa, negocio o servicio. Aprende de tu negocio hasta convertirse en un experto en tu realidad, trabaja 24/7 y te ayuda con análisis personalizados para detectar oportunidades, anticipar riesgos, encontrar mejoras y decidir con más claridad cómo crecer." },
    { q: "¿Para qué tipo de negocio sirve?", a: "Sirve para todo tipo de empresa, negocio o servicio, físico o remoto. Puede adaptarse a comercios, restaurantes, clínicas, agencias, estudios profesionales, marcas personales, emprendimientos, consultoras, academias, negocios digitales, servicios B2B y proyectos en crecimiento." },
    { q: "¿Cómo funciona?", a: "Cargás información sobre tu negocio, objetivos, clientes, procesos y desafíos. A partir de eso, la IA aprende de tus datos, integraciones y particularidades hasta volverse cada vez más experta en tu negocio, para generar insights, alertas, misiones, predicciones y recomendaciones personalizadas." },
