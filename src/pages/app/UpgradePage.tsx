  ...
  const plans = [
    {
      id: "pro_monthly",
      name: "Pro Mensual",
      price: isArgentina ? "$15.000 ARS" : "$29 USD",
      period: "/mes",
      popular: false,
      features: [
        "Análisis de reputación IA ilimitado",
        "Conexión con todas las plataformas",
        "Sincronización minuto a minuto",
        "Misiones ilimitadas",
        "Radar I+D Premium",
        "Soporte prioritario",
      ],
    },
    {
      id: "pro_yearly",
      name: "Pro Anual",
      price: isArgentina ? "$150.000 ARS" : "$290 USD",
      period: "/año",
      popular: true,
      savings: isArgentina ? "Ahorrá $30.000" : "Save $58",
      features: [
