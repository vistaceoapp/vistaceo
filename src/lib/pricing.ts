...
export const LOCAL_PRICES: Record<CountryCode | "DEFAULT", {
  ...
  AR: { monthly: 49990, yearly: 287880, currency: "ARS", symbol: "$" },
  CL: { monthly: 42990, yearly: 239880, currency: "CLP", symbol: "$" },
  CO: { monthly: 199900, yearly: 1198800, currency: "COP", symbol: "$" },
  CR: { monthly: 24990, yearly: 149880, currency: "CRC", symbol: "₡" },
  EC: { monthly: 49, yearly: 290, currency: "USD", symbol: "$" },
  MX: { monthly: 849, yearly: 4740, currency: "MXN", symbol: "$" },
  PA: { monthly: 49, yearly: 290, currency: "USD", symbol: "$" },
  PY: { monthly: 369900, yearly: 2159880, currency: "PYG", symbol: "₲" },
  UY: { monthly: 1990, yearly: 11880, currency: "UYU", symbol: "$" },
  BO: { monthly: 339, yearly: 1908, currency: "BOB", symbol: "Bs" },
  DO: { monthly: 2890, yearly: 16680, currency: "DOP", symbol: "RD$" },
