...
function getUniversalBaseQuestions(mode: 'quick' | 'complete'): UniversalQuestion[] {
  // Base questions that apply to all businesses (12 questions for quick mode)
  ...
  // Extended questions for complete mode (to reach 65-75 when padding is needed)
  const completeExtras: UniversalQuestion[] = [
    ...
    },
    {
      ...
      type: 'single',
      options: [
        { id: '<20', label: { es: 'Menos de 20h', 'pt-BR': 'Menos de 20h' }, emoji: '⏰' },
        { id: '20-40', label: { es: '20-40h', 'pt-BR': '20-40h' }, emoji: '💼' },
        { id: '40-60', label: { es: '40-60h', 'pt-BR': '40-60h' }, emoji: '🔥' },
        { id: '60+', label: { es: 'Más de 60h', 'pt-BR': 'Mais de 60h' }, emoji: '💯' },
      ],
    },
    {
      id: 'U17_EMPLOYEE_TURNOVER',
      category: 'team',
      mode: 'complete',
      dimension: 'team',
      weight: 7,
      title: { es: '¿Cuál es tu nivel de rotación de empleados?', 'pt-BR': 'Qual é seu nível de rotatividade de funcionários?' },
      type: 'single',
      options: [
        { id: 'low', label: { es: 'Bajo (casi no rotan)', 'pt-BR': 'Baixo (quase não rotam)' }, emoji: '✅' },
        { id: 'medium', label: { es: 'Medio (algunos cambios)', 'pt-BR': 'Médio (algumas mudanças)' }, emoji: '⚠️' },
        { id: 'high', label: { es: 'Alto (cambios frecuentes)', 'pt-BR': 'Alto (mudanças frequentes)' }, emoji: '🔄' },
        { id: 'na', label: { es: 'No aplica (sin empleados)', 'pt-BR': 'Não se aplica (sem funcionários)' }, emoji: '👤' },
      ],
    },
    {
      id: 'U18_TRAINING',
      ...
      dimension: 'team',
      weight: 6,
      title: { es: '¿Ofrecés capacitación a tu equipo?', 'pt-BR': 'Você oferece treinamento para sua equipe?' },
      type: 'single',
      options: [
        { id: 'formal', label: { es: 'Sí, programa formal', 'pt-BR': 'Sim, programa formal' }, emoji: '🎓' },
        { id: 'informal', label: { es: 'Sí, informal/en el trabajo', 'pt-BR': 'Sim, informal/no trabalho' }, emoji: '🤝' },
    ...
    },
    {
      ...
      dimension: 'finances',
      weight: 8,
      title: { es: '¿Conocés tus costos fijos mensuales?', 'pt-BR': 'Você conhece seus custos fixos mensais?' },
      type: 'single',
      options: [
        { id: 'exact', label: { es: 'Sí, con exactitud', 'pt-BR': 'Sim, com exatidão' }, emoji: '📊' },
        { id: 'approx', label: { es: 'Aproximadamente', 'pt-BR': 'Aproximadamente' }, emoji: '🤔' },
        { id: 'no', label: { es: 'No los tengo claros', 'pt-BR': 'Não tenho clareza' }, emoji: '❌' },
      ],
    },
    {
      id: 'U20_PROFIT_MARGIN',
      category: 'finance',
      mode: 'complete',
      dimension: 'profitability',
      weight: 9,
      title: { es: '¿Cuál es tu margen de ganancia aproximado?', 'pt-BR': 'Qual é sua margem de lucro aproximada?' },
      type: 'single',
      options: [
    ...
    },
    {
      ...
      dimension: 'finances',
      weight: 8,
      title: { es: '¿Cómo está tu flujo de caja habitualmente?', 'pt-BR': 'Como está seu fluxo de caixa geralmente?' },
      type: 'single',
      options: [
        { id: 'positive', label: { es: 'Positivo (sobra)', 'pt-BR': 'Positivo (sobra)' }, emoji: '✅' },
        { id: 'tight', label: { es: 'Justo (mes a mes)', 'pt-BR': 'Apertado (mês a mês)' }, emoji: '⚠️' },
        { id: 'negative', label: { es: 'Negativo (falta)', 'pt-BR': 'Negativo (falta)' }, emoji: '🔴' },
        { id: 'variable', label: { es: 'Variable', 'pt-BR': 'Variável' }, emoji: '📊' },
      ],
    },
    {
      id: 'U22_PAYMENT_TERMS',
      category: 'finance',
      mode: 'complete',
      dimension: 'finances',
      weight: 7,
      title: { es: '¿Cómo cobras principalmente?', 'pt-BR': 'Como você cobra principalmente?' },
      type: 'multi',
      options: [
        { id: 'cash', label: { es: 'Efectivo', 'pt-BR': 'Dinheiro' }, emoji: '💵' },
        { id: 'card', label: { es: 'Tarjeta', 'pt-BR': 'Cartão' }, emoji: '💳' },
        { id: 'transfer', label: { es: 'Transferencia', 'pt-BR': 'Transferência' }, emoji: '🏦' },
        { id: 'digital', label: { es: 'Billetera digital', 'pt-BR': 'Carteira digital' }, emoji: '📱' },
        { id: 'credit', label: { es: 'Fiado/Crédito', 'pt-BR': 'Fiado/Crédito' }, emoji: '📝' },
      ],
    },
    {
      id: 'U23_PRICING_REVIEW',
      category: 'sales',
      mode: 'complete',
      dimension: 'profitability',
      weight: 7,
      title: { es: '¿Cuándo fue la última vez que revisaste tus precios?', 'pt-BR': 'Quando foi a última vez que você revisou seus preços?' },
      type: 'single',
      options: [
        { id: 'recent', label: { es: 'Último mes', 'pt-BR': 'Último mês' }, emoji: '✅' },
        { id: '3months', label: { es: 'Últimos 3 meses', 'pt-BR': 'Últimos 3 meses' }, emoji: '📅' },
        { id: '6months', label: { es: 'Últimos 6 meses', 'pt-BR': 'Últimos 6 meses' }, emoji: '⚠️' },
        { id: 'year+', label: { es: 'Hace más de un año', 'pt-BR': 'Há mais de um ano' }, emoji: '🔴' },
      ],
    },
    {
      id: 'U24_REPEAT_CUSTOMERS',
      category: 'sales',
      mode: 'complete',
      dimension: 'reputation',
      weight: 8,
      title: { es: '¿Qué % de clientes vuelven a comprarte?', 'pt-BR': 'Que % de clientes voltam a comprar?' },
      type: 'slider',
      min: 0,
      max: 100,
      unit: '%',
    },
    {
      ...
      dimension: 'efficiency',
      weight: 6,
      title: { es: '¿Tenés una base de datos de clientes?', 'pt-BR': 'Você tem um banco de dados de clientes?' },
      type: 'single',
      options: [
        { id: 'crm', label: { es: 'Sí, CRM/Sistema', 'pt-BR': 'Sim, CRM/Sistema' }, emoji: '💻' },
        { id: 'excel', label: { es: 'Sí, Excel/Planilla', 'pt-BR': 'Sim, Excel/Planilha' }, emoji: '📊' },
        { id: 'informal', label: { es: 'Informal (WhatsApp, contactos)', 'pt-BR': 'Informal (WhatsApp, contatos)' }, emoji: '📱' },
        { id: 'none', label: { es: 'No tengo', 'pt-BR': 'Não tenho' }, emoji: '❌' },
      ],
    },
    {
      id: 'U26_SALES_CHANNEL_MIX',
      category: 'sales',
      mode: 'complete',
      dimension: 'traffic',
      weight: 7,
      title: { es: '¿Cuál es tu canal de venta más importante?', 'pt-BR': 'Qual é seu canal de venda mais importante?' },
      type: 'single',
      options: [
        { id: 'physical', label: { es: 'Local físico', 'pt-BR': 'Loja física' }, emoji: '🏪' },
        { id: 'online', label: { es: 'Online/E-commerce', 'pt-BR': 'Online/E-commerce' }, emoji: '🌐' },
        { id: 'social', label: { es: 'Redes sociales', 'pt-BR': 'Redes sociais' }, emoji: '📱' },
        { id: 'whatsapp', label: { es: 'WhatsApp', 'pt-BR': 'WhatsApp' }, emoji: '💬' },
        { id: 'mixed', label: { es: 'Varios por igual', 'pt-BR': 'Vários igualmente' }, emoji: '🔄' },
      ],
    },
    {
      id: 'U27_REVIEWS_RESPONSE',
      category: 'reputation',
      mode: 'complete',
      dimension: 'reputation',
      weight: 7,
      title: { es: '¿Respondés las reseñas online?', 'pt-BR': 'Você responde às avaliações online?' },
      type: 'single',
      options: [
        { id: 'all', label: { es: 'Sí, todas', 'pt-BR': 'Sim, todas' }, emoji: '✅' },
        { id: 'some', label: { es: 'Solo las negativas', 'pt-BR': 'Só as negativas' }, emoji: '⚠️' },
        { id: 'rarely', label: { es: 'Raramente', 'pt-BR': 'Raramente' }, emoji: '😕' },
    ...
    },
    {
      ...
      dimension: 'reputation',
      weight: 7,
      title: { es: '¿Cuántas quejas/reclamos recibís por mes?', 'pt-BR': 'Quantas reclamações você recebe por mês?' },
      type: 'single',
      options: [
        { id: 'none', label: { es: 'Casi ninguna', 'pt-BR': 'Quase nenhuma' }, emoji: '✅' },
        { id: 'few', label: { es: 'Pocas (1-5)', 'pt-BR': 'Poucas (1-5)' }, emoji: '👍' },
        { id: 'some', label: { es: 'Algunas (6-15)', 'pt-BR': 'Algumas (6-15)' }, emoji: '⚠️' },
        { id: 'many', label: { es: 'Muchas (+15)', 'pt-BR': 'Muitas (+15)' }, emoji: '🔴' },
      ],
    },
    {
      id: 'U29_MARKETING_BUDGET',
      category: 'marketing',
      mode: 'complete',
      dimension: 'traffic',
      weight: 6,
      title: { es: '¿Cuánto invertís en marketing por mes?', 'pt-BR': 'Quanto você investe em marketing por mês?' },
      type: 'single',
      options: [
        { id: 'nothing', label: { es: 'Nada', 'pt-BR': 'Nada' }, emoji: '❌' },
        { id: 'low', label: { es: 'Poco (menos del 5% de ventas)', 'pt-BR': 'Pouco (menos de 5% das vendas)' }, emoji: '💵' },
        { id: 'medium', label: { es: 'Moderado (5-10%)', 'pt-BR': 'Moderado (5-10%)' }, emoji: '💰' },
        { id: 'high', label: { es: 'Alto (+10%)', 'pt-BR': 'Alto (+10%)' }, emoji: '🚀' },
      ],
    },
    {
      id: 'U30_CONTENT_CREATION',
      category: 'marketing',
      mode: 'complete',
      dimension: 'traffic',
      weight: 6,
      title: { es: '¿Quién crea el contenido para redes?', 'pt-BR': 'Quem cria o conteúdo para redes?' },
      type: 'single',
      options: [
        { id: 'owner', label: { es: 'Yo mismo/a', 'pt-BR': 'Eu mesmo/a' }, emoji: '👤' },
        { id: 'employee', label: { es: 'Empleado interno', 'pt-BR': 'Funcionário interno' }, emoji: '👥' },
        { id: 'agency', label: { es: 'Agencia/Freelance', 'pt-BR': 'Agência/Freelance' }, emoji: '🎨' },
        { id: 'none', label: { es: 'No creo contenido', 'pt-BR': 'Não crio conteúdo' }, emoji: '❌' },
      ],
    },
    {
      id: 'U31_POSTING_FREQUENCY',
      category: 'marketing',
      mode: 'complete',
      dimension: 'traffic',
      weight: 5,
      title: { es: '¿Con qué frecuencia publicás en redes?', 'pt-BR': 'Com que frequência você posta nas redes?' },
      type: 'single',
      options: [
        { id: 'daily', label: { es: 'Diario', 'pt-BR': 'Diário' }, emoji: '🔥' },
        { id: '3-5week', label: { es: '3-5 veces/semana', 'pt-BR': '3-5 vezes/semana' }, emoji: '📅' },
        { id: '1-2week', label: { es: '1-2 veces/semana', 'pt-BR': '1-2 vezes/semana' }, emoji: '📱' },
        { id: 'rarely', label: { es: 'Esporádico', 'pt-BR': 'Esporádico' }, emoji: '😕' },
        { id: 'never', label: { es: 'Nunca', 'pt-BR': 'Nunca' }, emoji: '❌' },
      ],
    },
    {
      id: 'U32_EMAIL_MARKETING',
      category: 'marketing',
      mode: 'complete',
      dimension: 'traffic',
      weight: 5,
      title: { es: '¿Hacés email marketing?', 'pt-BR': 'Você faz email marketing?' },
      type: 'single',
      options: [
    ...
    {
      id: 'U33_OPERATIONAL_HOURS',
      category: 'operation',
      mode: 'complete',
      dimension: 'efficiency',
      weight: 6,
      title: { es: '¿Cuántos días a la semana operás?', 'pt-BR': 'Quantos dias por semana você opera?' },
      type: 'single',
      options: [
        { id: '5', label: { es: '5 días (lunes a viernes)', 'pt-BR': '5 dias (segunda a sexta)' }, emoji: '💼' },
        { id: '6', label: { es: '6 días', 'pt-BR': '6 dias' }, emoji: '📅' },
        { id: '7', label: { es: '7 días', 'pt-BR': '7 dias' }, emoji: '🔥' },
        { id: 'variable', label: { es: 'Variable', 'pt-BR': 'Variável' }, emoji: '📊' },
      ],
    },
    {
      id: 'U34_PROCESSES_DOCUMENTED',
      category: 'operation',
      mode: 'complete',
      dimension: 'efficiency',
      weight: 6,
      title: { es: '¿Tenés procesos documentados?', 'pt-BR': 'Você tem processos documentados?' },
      type: 'single',
      options: [
        { id: 'full', label: { es: 'Sí, manuales completos', 'pt-BR': 'Sim, manuais completos' }, emoji: '📚' },
        { id: 'partial', label: { es: 'Algunos', 'pt-BR': 'Alguns' }, emoji: '📝' },
        { id: 'none', label: { es: 'No', 'pt-BR': 'Não' }, emoji: '❌' },
      ],
    },
    {
      ...
      dimension: 'efficiency',
      weight: 7,
      title: { es: '¿Dónde se genera más cuello de botella?', 'pt-BR': 'Onde ocorre mais gargalo?' },
      type: 'multi',
      options: [
        { id: 'production', label: { es: 'Producción/Servicio', 'pt-BR': 'Produção/Serviço' }, emoji: '⚙️' },
        { id: 'delivery', label: { es: 'Entrega/Despacho', 'pt-BR': 'Entrega/Despacho' }, emoji: '🚚' },
        { id: 'sales', label: { es: 'Ventas/Atención', 'pt-BR': 'Vendas/Atendimento' }, emoji: '💼' },
        { id: 'admin', label: { es: 'Administración', 'pt-BR': 'Administração' }, emoji: '📊' },
        { id: 'none', label: { es: 'No tengo cuellos claros', 'pt-BR': 'Não tenho gargalos claros' }, emoji: '✅' },
      ],
    },
    {
      id: 'U36_SUPPLIERS',
      ...
      type: 'single',
      options: [
        { id: '1-3', label: { es: '1-3', 'pt-BR': '1-3' }, emoji: '📦' },
        { id: '4-8', label: { es: '4-8', 'pt-BR': '4-8' }, emoji: '📊' },
        { id: '9-15', label: { es: '9-15', 'pt-BR': '9-15' }, emoji: '🏢' },
        { id: '15+', label: { es: 'Más de 15', 'pt-BR': 'Mais de 15' }, emoji: '🌐' },
      ],
    },
    {
      id: 'U37_SUPPLIER_ISSUES',
      category: 'operation',
      mode: 'complete',
      dimension: 'efficiency',
      weight: 6,
      title: { es: '¿Tenés problemas frecuentes con proveedores?', 'pt-BR': 'Você tem problemas frequentes com fornecedores?' },
      type: 'single',
      options: [
        { id: 'never', label: { es: 'Nunca/Casi nunca', 'pt-BR': 'Nunca/Quase nunca' }, emoji: '✅' },
        { id: 'sometimes', label: { es: 'A veces', 'pt-BR': 'Às vezes' }, emoji: '⚠️' },
        { id: 'often', label: { es: 'Frecuentemente', 'pt-BR': 'Frequentemente' }, emoji: '🔴' },
      ],
    },
    {
      id: 'U38_TECH_ADOPTION',
      category: 'operation',
      mode: 'complete',
      dimension: 'efficiency',
      weight: 6,
      title: { es: '¿Cómo te describís con la tecnología?', 'pt-BR': 'Como você se descreve com tecnologia?' },
      type: 'single',
      options: [
        { id: 'early', label: { es: 'Adopto temprano, me gusta probar', 'pt-BR': 'Adoto cedo, gosto de testar' }, emoji: '🚀' },
        { id: 'pragmatic', label: { es: 'Pragmático, uso lo que funciona', 'pt-BR': 'Pragmático, uso o que funciona' }, emoji: '⚙️' },
        { id: 'late', label: { es: 'Tardío, solo cuando es necesario', 'pt-BR': 'Tardio, só quando necessário' }, emoji: '🐢' },
        { id: 'resistant', label: { es: 'Resistente, prefiero lo tradicional', 'pt-BR': 'Resistente, prefiro o tradicional' }, emoji: '📜' },
      ],
    },
    {
      id: 'U39_EXPANSION_PLANS',
      category: 'goals',
      mode: 'complete',
      dimension: 'growth',
      weight: 7,
      title: { es: '¿Tenés planes de expandirte?', 'pt-BR': 'Você tem planos de expandir?' },
      type: 'single',
      options: [
        { id: 'yes_soon', label: { es: 'Sí, en los próximos 6 meses', 'pt-BR': 'Sim, nos próximos 6 meses' }, emoji: '🚀' },
        { id: 'yes_year', label: { es: 'Sí, en 1-2 años', 'pt-BR': 'Sim, em 1-2 anos' }, emoji: '📅' },
        { id: 'maybe', label: { es: 'Lo estoy evaluando', 'pt-BR': 'Estou avaliando' }, emoji: '🤔' },
        { id: 'no', label: { es: 'No, prefiero consolidar', 'pt-BR': 'Não, prefiro consolidar' }, emoji: '🏠' },
      ],
    },
    {
      id: 'U40_EXIT_STRATEGY',
      category: 'goals',
      mode: 'complete',
      dimension: 'growth',
      weight: 5,
      title: { es: '¿Pensás vender o traspasar el negocio algún día?', 'pt-BR': 'Você pensa em vender ou transferir o negócio algum dia?' },
      type: 'single',
      options: [
        { id: 'yes_soon', label: { es: 'Sí, en los próximos años', 'pt-BR': 'Sim, nos próximos anos' }, emoji: '💰' },
        { id: 'someday', label: { es: 'Algún día, no pronto', 'pt-BR': 'Algum dia, não logo' }, emoji: '⏳' },
        { id: 'family', label: { es: 'Lo pasaré a familia', 'pt-BR': 'Passarei para família' }, emoji: '👨‍👩‍👧' },
        { id: 'never', label: { es: 'Nunca, es mi proyecto de vida', 'pt-BR': 'Nunca, é meu projeto de vida' }, emoji: '❤️' },
      ],
    },
    {
      id: 'U41_MAIN_RISK',
      ...
      dimension: 'efficiency',
      weight: 7,
      title: { es: '¿Cuál es tu mayor preocupación actual?', 'pt-BR': 'Qual é sua maior preocupação atual?' },
      type: 'single',
      options: [
        { id: 'competition', label: { es: 'Competencia', 'pt-BR': 'Concorrência' }, emoji: '⚔️' },
        { id: 'economy', label: { es: 'Economía/Inflación', 'pt-BR': 'Economia/Inflação' }, emoji: '📉' },
        { id: 'cashflow', label: { es: 'Flujo de caja', 'pt-BR': 'Fluxo de caixa' }, emoji: '💸' },
        { id: 'team', label: { es: 'Encontrar buen personal', 'pt-BR': 'Encontrar bom pessoal' }, emoji: '👥' },
        { id: 'burnout', label: { es: 'Mi propio agotamiento', 'pt-BR': 'Meu próprio esgotamento' }, emoji: '😓' },
      ],
    },
    {
      id: 'U42_SUCCESS_METRIC',
      category: 'goals',
      mode: 'complete',
      dimension: 'growth',
      weight: 8,
      title: { es: '¿Cómo medís el éxito de tu negocio?', 'pt-BR': 'Como você mede o sucesso do seu negócio?' },
      type: 'single',
      options: [
        { id: 'revenue', label: { es: 'Facturación', 'pt-BR': 'Faturamento' }, emoji: '💰' },
        { id: 'profit', label: { es: 'Ganancias/Margen', 'pt-BR': 'Lucros/Margem' }, emoji: '📈' },
        { id: 'clients', label: { es: 'Cantidad de clientes', 'pt-BR': 'Quantidade de clientes' }, emoji: '👥' },
        { id: 'reputation', label: { es: 'Reputación/Reseñas', 'pt-BR': 'Reputação/Avaliações' }, emoji: '⭐' },
        { id: 'balance', label: { es: 'Balance vida-trabajo', 'pt-BR': 'Equilíbrio vida-trabalho' }, emoji: '⚖️' },
      ],
    },
  ];
...
export function getUniversalQuestionsForSetup(
  ...
  const expectedMin = setupMode === 'quick' ? 10 : 65;
